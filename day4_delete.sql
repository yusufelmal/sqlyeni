...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/
      DELETE FROM ogrenciler
      WHERE isim = 'Nesibe Yilmaz' OR isim = 'Mustafa Bak';--or burda veya gibi deðil de ikisini de sil demek. and olsaydý ayný anda bu ikisini de taþýyaný sil diyecekti. ayný satýrda mantýklý ama iki farklý satýr için genelde or kullanýyoruz. 
